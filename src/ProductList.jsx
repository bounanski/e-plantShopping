...
function ProductList({ onHomeClick }) {
  ...
  const plantsArray = [
    ...
    },
    {
      ...
      plants: [
        ...
        { name: "Geraniums", image: "https://cdn.pixabay.com/photo/2012/04/26/21/51/flowerpot-43270_1280.jpg", description: "Repels insects, adds pleasant scent.", cost: "$20" },
    ...
    },
    {
      ...
      plants: [
        { name: "ZZ Plant", image: "https://images.unsplash.com/photo-1632207691143-643e2a9a9361?q=80&w=464&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", description: "Thrives in low light, minimal watering.", cost: "$25" },
        ...
        { name: "Aglaonema", image: "https://cdn.pixabay.com/photo/2014/10/10/04/27/aglaonema-482915_1280.jpg", description: "Adds color indoors.", cost: "$22" }
      ]
    }
  ];
  ...
  const styleA = { color: 'white', fontSize: '30px', textDecoration: 'none', display: 'flex', alignItems: 'center' };
  const counterStyle = { marginLeft: '8px', fontSize: '18px', fontWeight: 'bold', color: 'yellow' };
      ...
      <div className="navbar" style={styleObj}>
        <div className="tag">
          <div className="luxury">
            <img src="https://img.freepik.com/premium-vector/green-plant-logo-with-hand-circle_898845-4.jpg" alt="" />
            <a href="/" onClick={handleHomeClick}>
              <div>
                <h3 style={{ color: 'white' }}>BENYAHIA Plants Paradise</h3>
                <i style={{ color: 'white' }}>Your Gateway to Natural Beauty</i>
              </div>
            </a>
          </div>
        </div>
        <div style={styleObjUl}>
          ...
          <div>
            <a href="#" onClick={handleCartClick} style={styleA}>
              ...
              {cartCount > 0 && <span style={counterStyle}>{cartCount}</span>}
            </a>
          </div>
        </div>
      </div>
